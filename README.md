...
- 🚀 **Have historical embeddings?**: Don't want to re-embed all your old source texts to a new model? No worries, invoke an adapter and use the new model on your queries.
